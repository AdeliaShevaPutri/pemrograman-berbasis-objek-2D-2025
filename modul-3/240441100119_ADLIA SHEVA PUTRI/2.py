...
class Internasional(Darat, Udara):
    ...
    def waktu_pengiriman(self):
        waktu = 0
        tujuan_dalam_negeri = ["indonesia", "surabaya", "bandung", "gresik", "lamongan","jakarta","bangkalan",
                               "sidoarjo","jember","ponorogo","probolinggo","pandaan","bekasi","medan","tuban","tulungangung","makassar",
                                "palembang","denpasar","pontianak","pekanbaru","balikpapan","banjarmasin"
                               "kediri", "jombang", "jogja", "bali", "lumajang", "malang", "pasuruan"]
...
tujuan = input("Masukkan tujuan pengiriman (dalam negeri/luar negeri): ")
